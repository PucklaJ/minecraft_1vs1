...
public class ChooseKit
{
	...
	public Kit getKit()
	{
		if(otherPlayer == null && otherOPlayer == null)
		{
			return KitManager.getKit(player, myNumber);
		}
		else
		{
			return KitManager.getKits(otherPlayer != null ? otherPlayer.getUniqueId() : otherOPlayer.getUniqueId()).get(otherNumber);
		}
