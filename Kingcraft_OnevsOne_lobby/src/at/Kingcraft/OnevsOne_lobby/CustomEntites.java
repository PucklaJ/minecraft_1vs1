...
public enum CustomEntites {

SKELETON("Skeleton",51,EntityType.SKELETON,EntitySkeleton.class,KitSkeleton.class),
ZOMBIE("Zombie",54,EntityType.ZOMBIE,EntityZombie.class,WaitingEntity.class);
...
private CustomEntites(String name, int id, EntityType entityType, Class<? extends EntityInsentient> nmsClass,
...
for (CustomEntites entity : values())
