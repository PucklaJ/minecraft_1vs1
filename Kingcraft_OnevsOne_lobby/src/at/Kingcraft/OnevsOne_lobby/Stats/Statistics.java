...
public class Statistics
{
	...
	public static Statistics fromString(String str)
	{
		...
		return new Statistics(Integer.valueOf(str1[0]), Integer.valueOf(str1[1]), Integer.valueOf(str1[2]), Integer.valueOf(str1[3]),Integer.valueOf(str1[4]),Integer.valueOf(str1[5]),-1);
	}
	...
	{
		p.sendMessage(Messages.stats(getKills(), getDeaths(), getKD(), getPlays(), getWins(), getLoses(), round(getWinsPerPlay()*100.0, 1), getTournamentWins(),elo));
	}
}
